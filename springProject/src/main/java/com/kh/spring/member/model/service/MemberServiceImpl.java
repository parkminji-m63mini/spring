...
@Service // Service 레이어, 비즈니스 로직 처리를 하는 클래스임을 명시 + Bean(스프링 컨테이너) 등록
public class MemberServiceImpl implements MemberService {
	...
	public Member login(Member member){
		...
		// BCryptPasswordEncoder에서 제공하는 matched() 메소드를 이용해서
	...
	//	* 트랜잭션 처리를 위해서는 트랜잭션 매니저가 bean으로 등록되어 있어야함.
	//  	-> root-context.xml 작성

	
	// @Transactional 어노테이션이 판별하는 정상 수행이란
	// RuntimeException의 발생되지 않은 경우를 나타냄.
